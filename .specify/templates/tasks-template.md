...
- [ ] T004 Review applicable repository guidance in AGENTS.md and relevant local skills
...
- [ ] T019 [US1] Verify feature behavior with the affected module toolchain
...
- [ ] T026 [US2] Verify feature behavior with the affected module toolchain
...
- [ ] T032 [US3] Verify feature behavior with the affected module toolchain
...
- [ ] TXXX Confirm English-only user-facing text and non-obvious comments only
