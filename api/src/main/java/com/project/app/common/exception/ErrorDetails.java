...
public class ErrorDetails {
    ...
    /**
     * The human-readable description for an issue. Provide non-standard more
     * granular error message.
     */
    String detail;

    /**
     * The field that caused the error. If the field is in the body, set this value
     * to the JSON pointer to that field.
